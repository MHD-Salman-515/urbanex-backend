-- URGENT HOTFIX: OTP compatibility without destructive migration
-- NOTE:
-- - Plain SQL only (no PREPARE/EXECUTE) to stay compatible with Prisma MySQL protocol.
-- - Duplicate/exists errors are handled in app-level try/catch in main.ts.
